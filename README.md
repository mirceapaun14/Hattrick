...
You see there are 2 values and you have a / between them. Those are actual level and potential level. 
If you do not know actual level, write 1. If you do not know potential level, write 8
Notice on my guys, at def, i put 6.3. That is my estimation of training on them, as i know i trained them at 2 times in def+def extended
